...
from .train import evaluate_disentanglement, evaluate_r2
...
class ChemCPA(L.LightningModule):
    ...
    def on_train_end(self):
        ...
        if self.config["training"].get("run_eval_r2", False):
            ...
            results = {
                "train": {
                    "R2_mean": _train_eval[0],
                    "R2_mean_de": _train_eval[1],
                    "R2_var": _train_eval[2],
                    "R2_var_de": _train_eval[3]
                },
                "test": {
                    "R2_mean": _test_eval[0],
                    "R2_mean_de": _test_eval[1],
                    "R2_var": _test_eval[2],
                    "R2_var_de": _test_eval[3]
                },
                "ood": {
                    "R2_mean": _ood_eval[0],
                    "R2_mean_de": _ood_eval[1],
                    "R2_var": _ood_eval[2],
                    "R2_var_de": _ood_eval[3]
                }
            }
